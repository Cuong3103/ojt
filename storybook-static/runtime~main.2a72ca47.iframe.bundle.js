(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (187 === chunkId ? "stories-Configure-mdx" : chunkId) +
      "." +
      {
        7: "5ea45d80",
        71: "2d24cdeb",
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute("data-webpack") == "nhom-2:" + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute("data-webpack", "nhom-2:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunknhom_2 =
          self.webpackChunknhom_2 || []);
