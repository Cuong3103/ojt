...
const TrainingProgramDetail = ({ params }: { params: { slug: string } }) => {
  ...
  return (
    <section className={"createpage w-full"}>
      ...
      <div className="flex items-center gap-5 py-4 px-4 bg-primary-color w-full">
        <h2 className={"text-[32px] tracking-[0.02px] font-semibold text-white"}>Hello</h2>
      ...
      <div className="container px-4 m-auto ">
        ...
        <div className="wrap-generalinformation">

        </div>
        <div className={"wrap-content pt-3"}>
