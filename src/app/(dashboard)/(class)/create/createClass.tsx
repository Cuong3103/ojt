...
const CreateClassDetailPage: FC<CreateClassProps> = ( {className}) => {
        ...
        <div>
            <div className=" white-box border-2 bg-primary-color border-gray-400 h-60 text-white pl-8" >
                <div className="mt-7 text-[30px]" >
                    ...
                    <div className="flex items-center  text-[35px] gap-5 mt-6 " style={{ marginBottom: "2px" }}>
                        ...
                        <details className="dropdown dropdown-end" style={{ marginLeft: "300px" }}>
                            <summary className="btn btn-ghost rounded-btn " >{<TfiMoreAlt fontSize={'30px'}/>}</summary>
                                <ul className="p-1 menu dropdown-content z-[1] bg-white w-40">
                                    <li className="text-blue-600"><a><FaPen/> Edit Class</a></li>
                                    <li className="text-blue-600"><a><FaTrashCan/> Delete Class</a></li>
                                </ul>
                        </details>
                    </div>
                </div>
                <hr style={{ borderTop: "1px solid white", margin: "16px 0", width: "58%" }} />
                <div style={{ fontSize: "17px", marginLeft: "30px", letterSpacing: '0.2em' }}>days<span style={{ fontStyle: "italic" }}>    (    hours)</span>          |</div>
            </div>
            ...
            <div className=" mt-[30px] ml-[20px] flex">
                <div>
                                ...
                                <div className=" flex  w-[318px] h-[33px] mt-[20px] ml-[25px] items-center ">
                                    ...
                                    <div className="flex ml-[40px]">
                                        <div>
                                            ...
                                            <input type="text" id="inputFrom" name="from" value={inputValue.from} onChange={handleInputChange} style={{ width: "59px", height: "27px", borderWidth: "2px", borderRadius: "0px", borderColor: "#DDDDDD", marginLeft: "10px" }} className="border " />
                                        </div>
                                        <div className="ml-[15px]">
                                            <label htmlFor="inputTo">to</label>
                                            <input type="text" id="inputTo" name="to" value={inputValue.to} onChange={handleInputChange} style={{ width: "50px", height: "27px", borderWidth: "2px", borderRadius: "0px", borderColor: "#DDDDDD", marginLeft: "10px" }} className="border" />
                                        </div>
                                    </div>
                    ...
                    <div>
                        <div className=" bg-gray-400 rounded-lg text-white mt-[30px] p-2 w-[373px] ">
                            <div className=" flex justify-between items-center cursor-pointer ml-[20px] mr-[20px] " onClick={toggleExpansionAttended}>
                ...
                <div className="">
                    <div className=" bg-gray-400 p-2 rounded-lg  text-white ml-[20px] w-[746px] " >
                        <div className=" flex justify-between items-center cursor-pointer ml-[20px] mr-[20px] " onClick={toggleExpansionTimeFrame}>
                            <FaRegCalendar className="w-[24px] h-[24px]" />
                            <span className="font-bold" style={{ marginRight: "50%" }}>Time Frame</span>
                            <div>
                    ...
                    {isExpandedTimeFrame && (
                        <div>
                            <DatePicker onDateSelect={handleDateSelect} selectDate={selectedDate}/>
            ...
            <div className="ml-[20px]">
                <div className=" white-box border-2 bg-primary-color border-gray-400 h-[95px] text-white ">
                    <div className="items-center font-bold mt-[10px] mb-[10px]  " style={{ letterSpacing: '0.3em' }} >
                        <span className="ml-[20px] text-[25px] ">DevOps Foundation</span>
                        <button className="ml-[20px] "><Image src="../assets/icons/create.svg" alt="" width={30} height={30} className="bg-white rounded-lg " /></button>
                    </div>
                    <div className="flex mb-[5px] ml-[20px]">
                        <div style={{ fontSize: "17px"}}>31 days<span style={{ fontStyle: "italic" }}>    (97 hours)</span>  |</div>
