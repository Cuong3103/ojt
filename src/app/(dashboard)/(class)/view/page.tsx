      ...
      {showCreateClassDetail ? (
        ...
        <div className="flex-1">
          <div className=" navbar white-box border-2 bg-primary-color border-gray-400 h-[59px] w-full  text-white text-[30px] tracking-wider  flex items-center  ">
            <div className="ml-[30px]" style={{ letterSpacing: "5px" }}>
              Training Class
            </div>
          </div>
          <div className="flex  ml-[30px] mt-[30px] text-white mr-[30px]  ">
            ...
            <div className="border-y-0 ml-[5px] ">
              <Button
                className="bg-[#2D3748] w-[85px] h-[40px] justify-center"
                title="Filter"
                icon={<IoFilterSharp />}
            ...
            <div
              ...
              className="h-[38px] w-[137px] border-y-0 ml-auto gap-[5px]"
            >
              <Button
                className="bg-[#D45B13] justify-center "
                title="Create Class"
